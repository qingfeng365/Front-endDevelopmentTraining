...
> `Sublime Text 3`可以免费使用，会弹出提示购买，[ESC]取消即可，不影响使用。
...
> 插件管理器安装好后，打开命令面板，输入`ppi`找到`Package Control:Install Package`命令
> 即可。
...
|           插件名称           |   插件用途   |                                 备注                                 |
|------------------------------|--------------|----------------------------------------------------------------------|
| Emmet                        | 代码生成器   | 安装该控件需要注意，网速如果有问题，可能安装失败主要原因是PyV8的问题 |
| HTML-CSS-JS Prettify         | 代码格式工具 |                                                                      |
| SublimeCodeIntel             | 代码补全     |                                                                      |
| ConvertToUTF8                | 中文乱码解决 | Sublime只使用UTF-8编码，其它编码的中文均会乱码，可用这个插件解决     |
| Monokai Extended             | 语法高亮主题 |                                                                      |
| Theme - Soda                 | 颜色主题     |                                                                      |
| ColorPicker                  | 颜色拾取器   |                                                                      |
| SideBarEnhancements          | 侧边栏增强   |                                                                      |
| DocBlockr                    | 注释生成工具 |                                                                      |
| JS Snippets                  | 代码片断     |                                                                      |
| JavaScript & NodeJS Snippets | 代码片断     |                                                                      |
| Emmet Css Snippets           |              |                                                                      |
...
| AngularJS Snippets           |              |                                                                      |
| JsFormat                     |              |                                                                      |
| Markdown Extended            | md颜色主题   |                                                                      |
| OmniMarkupPreviewer          | md实时预览   |                                                                      |
| MarkdownEditing              | md编辑增强   |                                                                      |
| ExpressComplete              |              |                                                                      |
